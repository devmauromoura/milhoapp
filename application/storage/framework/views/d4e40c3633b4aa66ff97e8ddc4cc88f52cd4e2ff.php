<?php $__env->startSection('title', 'MilhoAPP - Pratos'); ?>
      ...
      <div class="container"> <!-- Listar -->
        <div class="listar shadow">
            ...
            <table class="table table-sm" id="table">
                ...
                <tbody>
                    <?php $__currentLoopData = $listPratos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pratos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    <th scope="row"><?php echo e($pratos->id); ?></th>
                    <td><?php echo e($pratos->nome); ?></td>
                    <td><?php echo e($pratos->descricao); ?></td>
                    <td><?php echo e($pratos->valor); ?></td>
                    <td>
