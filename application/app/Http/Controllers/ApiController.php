...
class ApiController extends Controller
{
  ...
  public function teste(){
    ...
    $votos = Voto::select('idbarraca','nome','semestre','periodo','idcurso','curso','localizacao','nomeimagem',DB::raw('count(idbarraca) AS Votos'))->leftJoin('barraca','voto.idbarraca','=','barraca.id')->leftJoin('curso','idCurso','=','curso.id')->groupBy('idbarraca','barraca.nome','barraca.semestre','barraca.periodo','barraca.localizacao','barraca.nomeimagem','curso.nome AS cnome')->get();
