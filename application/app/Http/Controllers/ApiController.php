...
class ApiController extends Controller
{
  ...
  public function teste(){
    ...
    $votos = Voto::select('idbarraca','nome','semestre','periodo','idcurso','localizacao','nomeimagem','c.nome',DB::raw('count(idbarraca) AS votos'))->leftJoin('barraca','voto.idbarraca','=','barraca.id')->leftJoin('curso as c','idcurso','=','curso.id')->groupBy('idbarraca','barraca.nome','barraca.semestre','barraca.periodo','barraca.localizacao','barraca.nomeimagem')->get();
