...
class ApiController extends Controller
{
    public function barracaShow(){
      ...
      $dadosBarraca = Barraca::select('barraca.id AS id','barraca.nome AS nome','semestre','periodo','idcurso','curso.nome as cnome','localizacao','nomeimagem',DB::raw('count(idbarraca) AS votos'))->leftJoin('curso','curso.id','=','barraca.idcurso')->leftJoin('voto','barraca.id','=','voto.idbarraca')->groupBy('idbarraca','barraca.nome','barraca.semestre','barraca.periodo','barraca.localizacao','barraca.nomeimagem')->get();
